...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      stats_view: z.string().optional().default("<leader>d").describe("View stats dashboard"),
      ...
      session_usage: z.string().optional().default("<leader>i").describe("View session usage"),
