...
- `opencode.db` - SQLite database storing all session and message data

To find the exact path to the database file, run:

```bash
opencode db path
```

You can also open an interactive SQLite shell to inspect the database:
